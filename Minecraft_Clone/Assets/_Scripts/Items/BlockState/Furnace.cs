...
namespace Minecraft
{
    public class Furnace : IResultGiver, IBlockState
    {
        ...
        public Furnace(ref ByteString.BytesReader bytesReader)
        {
            ...
            smeltSlot.SetItem(ItemPacked.ParseFrom(ref bytesReader));
            burnSlot.SetItem(ItemPacked.ParseFrom(ref bytesReader));
            _resultSlot.SetItem(ItemPacked.ParseFrom(ref bytesReader));
        }
        ...
        public void GetSerializedData(ByteString byteString)
        {
            ...
            smeltSlot.GetPacked().WriteTo(byteString);
            burnSlot.GetPacked().WriteTo(byteString);
            _resultSlot.GetPacked().WriteTo(byteString);
        }
